...
export function GraphicSuscribers() {
  return (
    <div className="mt-5">
        <p className="text-3xl mb-3">456654.5 </p>
        <div className="flex gap-x-5 mb-5">
            ...
            <p className="text-slate-500">435 increased</p>
        </div>
        <div className="h-[350px]">
            <ResponsiveContainer width="100%" height="100%">
                <AreaChart width= {730} height={250} margin={{top:10, right:30, left:0, bottom:0}} data={dataGraphics}>
                <defs>
